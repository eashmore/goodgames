...
(function() { this.JST || (this.JST = {}); this.JST["games/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'row\'>\n  <div class=\'games-index-title\'>\n    <h3>Games</h3>\n  </div>\n\n    ');  games.forEach(function (game) { ; __p.push('\n      ');  if (game.escape('boxart_url') !== "" && game.id !== 16696) { ; __p.push('\n        <div class=\'game-thumb thumbnail pull-left text-center\'>\n          <a href="#games/',  game.id ,'">\n            <img id=\'boxart\' src=\'',  game.get('boxart_url') ,'\'></img>\n            <span class=\'caption\'>',  game.escape('name') ,'</span>\n          </a>\n        </div>\n      ');  } ; __p.push('\n    ');  }); ; __p.push('\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["games/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>\n  <h1>',  game.escape('name') ,'</h1>\n  <div class=\'row\'>\n    <img class=\'box-art\' src=\'',  game.escape('boxart_url') ,'\'/>\n    <div><strong id=\'score\'>\n      Average Score: ',  game.escape('score') ,'\n    </strong></div>\n    <div class=\'game-info\'>\n      About: ',  game.escape('deck') ,'\n    </div>\n  </div>\n  <div id=\'review-index\'></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["nav/nav"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<nav class="navbar navbar-default navbar-fixed-top">\n  <div class="container-fluid">\n    <div class="navbar-header">\n      <a class="navbar-brand" href="#">Goodgames</a>\n    </div>\n\n    <ul class="nav navbar-nav navbar-right">\n      <li id="search-bar"></li>\n      <li class="dropdown">\n        <a id=\'profile-dropdown\' href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">',  CURRENT_USER ,'<span class="caret"></span></a>\n        <ul class="dropdown-menu" role="menu">\n          <li><a href="#">Profile</a></li>\n          <li class="divider"></li>\n          <li><a href="/session/new">Log Out</a></li>\n        </ul>\n      </li>\n    </ul>\n\n  </div>\n</nav>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3>Write a review</h3>\n<div class="panel panel-default">\n  <div class="panel-heading">\n    <label>Score:\n      <label>\n        <input type="radio" name="review[score]" value="1">\n      1 </label>\n      <label>\n        <input type="radio" name="review[score]" value="2">\n      2 </label>\n      <label>\n        <input type="radio" name="review[score]" value="3">\n      3 </label>\n      <label>\n        <input type="radio" name="review[score]" value="4">\n      4 </label>\n      <label>\n        <input type="radio" name="review[score]" value="5">\n      5</label>\n    </label>\n  </div>\n  <div class="panel-body">\n    <label>Review\n      <br>\n      <textarea name="review[body]" rows="8" cols="80"></textarea>\n    </label>\n  </div>\n  <input type=\'hidden\' name=\'review[game_id]\' value=\'',  game_id ,'\'>\n  <div class="panel-footer">\n    <button class="btn btn-default" type="submit">Submit</button>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id=\'new-form\'></div>\n<h4>Community Reviews:</h4>\n<div id=\'review-list\'></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="panel panel-default">\n\n  <div class="panel-heading">\n    <strong>',  author.escape('username') ,'</strong> gave this game a\n    <strong>',  review.escape('score') ,'/5</strong>\n    <div class=\'pull-right\'>\n      Written on: ',  review.escape('created_at').slice(0, 10) ,'\n    </div>\n  </div>\n  <br>\n  <div class="panel-body">',  review.escape('body') ,'</div>\n  <div class="panel-footer a">\n    <a id=\'edit-review\' class=\'pull-right\' href="#">Edit Review</a>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["search_bar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="navbar-form navbar-right">\n  <div class="form-group">\n    <input type="text" name="query" class="query form-control" placeholder="Search by game title">\n  </div>\n  <button type="submit" class="btn btn-default">Search</button>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["search_results/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'row\'>\n  <div class=\'games-index-title\'>\n    <h3>Search Results:</h3>\n  </div>\n  <div id="results">\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["search_results/item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (game.get('image') && game.id !== 16696) { ; __p.push('\n  <div id=\'game-box\' class=\'game-thumb thumbnail pull-left text-center\'>\n    <a href="#/games/',  game.id ,'">\n      <img id=\'boxart\' src=\'',  game.get('image').small_url ,'\'></img>\n      <span class=\'caption\'>',  game.escape('name') ,'</span>\n    </a>\n  </div>\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
...
GoodgamesApp.Views.UsersIndex = Backbone.View.extend({
